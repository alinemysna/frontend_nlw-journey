import { Calendar, MapPin, Settings2, Plus, CircleCheck, Link2, UserCog, CircleDashed, X, Tag, Clock } from 'lucide-react'
            ...
            <div className='space-y-2.5'>
              ...
              <div className='space-y-2.5'>
                <div className='px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3'>
                  <CircleCheck className='sie-5 text-lime-300' />
              ...
              <div className='flex items-center justify-between gap-4'>
                <div className='space-y-1.5'>
                  ...
                  <a href='#' className='block text-xs text-zinc-400 truncate hover:text-zinc-200'>
                    https://www.airbnb.com.br/rooms/104700011677896453423133597897655
                    </a>
                </div>
                <Link2 className='text-zinc-400 size-5 shrink-8' />
              </div>
              <div className='flex items-center justify-between gap-4'>
                <div className='space-y-1.5'>
                  <span className='block font-medium text-zinc-100'>Reserva do AirBnB</span>
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-5'>
              <div className='flex items-center justify-between gap-4'>
                ...
                <CircleDashed className='text-zinc-400 size-5 shrink-8' />
              </div>
              <div className='flex items-center justify-between gap-4'>
                <div className='space-y-1.5'>
